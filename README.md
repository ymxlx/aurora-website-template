...
You may use, share, and adapt this template freely — **selling it or using it commercially is not permitted** without written permission. Attribution is required.
